...
-- data[9]	=>  Location: PIN_AG2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[1]	=>  Location: PIN_AF6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[15]	=>  Location: PIN_AK3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[7]	=>  Location: PIN_AG6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[11]	=>  Location: PIN_AH5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[3]	=>  Location: PIN_AJ2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[13]	=>  Location: PIN_AG10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[5]	=>  Location: PIN_AH9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[8]	=>  Location: PIN_AG5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[0]	=>  Location: PIN_AH3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[14]	=>  Location: PIN_AF11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[6]	=>  Location: PIN_AG11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[10]	=>  Location: PIN_AC12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[2]	=>  Location: PIN_AH2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[12]	=>  Location: PIN_AA13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data[4]	=>  Location: PIN_AA12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \mux5|pt2|f~4_combout\ = (!\sel[3]~input_o\ & ((\data[10]~input_o\))) # (\sel[3]~input_o\ & (\data[2]~input_o\))
...
-- Equation(s):
-- \mux5|pt2|f~5_combout\ = ( \data[12]~input_o\ & ( (!\sel[3]~input_o\) # (\data[4]~input_o\) ) ) # ( !\data[12]~input_o\ & ( (\sel[3]~input_o\ & \data[4]~input_o\) ) )
...
-- Equation(s):
-- \mux5|pt2|f~7_combout\ = ( !\sel[3]~input_o\ & ( (!\sel[1]~input_o\ & (((!\sel[2]~input_o\ & ((\data[14]~input_o\))) # (\sel[2]~input_o\ & (\mux5|pt2|f~4_combout\))))) # (\sel[1]~input_o\ & ((((\mux5|pt2|f~5_combout\ & !\sel[2]~input_o\))))) ) ) # ( 
-- \sel[3]~input_o\ & ( (!\sel[1]~input_o\ & (((!\sel[2]~input_o\ & ((\data[6]~input_o\))) # (\sel[2]~input_o\ & (\mux5|pt2|f~4_combout\))))) # (\sel[1]~input_o\ & ((((\mux5|pt2|f~5_combout\ & !\sel[2]~input_o\))))) ) )
...
-- Equation(s):
-- \mux5|pt2|f~3_combout\ = ( \data[0]~input_o\ & ( (\sel[2]~input_o\ & (\sel[1]~input_o\ & ((\sel[3]~input_o\) # (\data[8]~input_o\)))) ) ) # ( !\data[0]~input_o\ & ( (\sel[2]~input_o\ & (\sel[1]~input_o\ & (\data[8]~input_o\ & !\sel[3]~input_o\))) ) )
...
-- Equation(s):
-- \mux5|pt2|f~1_combout\ = ( \data[3]~input_o\ & ( (\data[11]~input_o\) # (\sel[3]~input_o\) ) ) # ( !\data[3]~input_o\ & ( (!\sel[3]~input_o\ & \data[11]~input_o\) ) )
...
-- Equation(s):
-- \mux5|pt2|f~2_combout\ = ( \data[5]~input_o\ & ( (\data[13]~input_o\) # (\sel[3]~input_o\) ) ) # ( !\data[5]~input_o\ & ( (!\sel[3]~input_o\ & \data[13]~input_o\) ) )
...
-- Equation(s):
-- \mux5|pt2|f~11_combout\ = ( !\sel[3]~input_o\ & ( (!\sel[1]~input_o\ & (((!\sel[2]~input_o\ & ((\data[15]~input_o\))) # (\sel[2]~input_o\ & (\mux5|pt2|f~1_combout\))))) # (\sel[1]~input_o\ & ((((\mux5|pt2|f~2_combout\ & !\sel[2]~input_o\))))) ) ) # ( 
-- \sel[3]~input_o\ & ( (!\sel[1]~input_o\ & (((!\sel[2]~input_o\ & ((\data[7]~input_o\))) # (\sel[2]~input_o\ & (\mux5|pt2|f~1_combout\))))) # (\sel[1]~input_o\ & ((((\mux5|pt2|f~2_combout\ & !\sel[2]~input_o\))))) ) )
...
-- Equation(s):
-- \mux5|pt2|f~0_combout\ = ( \sel[3]~input_o\ & ( (\sel[2]~input_o\ & (\sel[1]~input_o\ & \data[1]~input_o\)) ) ) # ( !\sel[3]~input_o\ & ( (\sel[2]~input_o\ & (\sel[1]~input_o\ & \data[9]~input_o\)) ) )
